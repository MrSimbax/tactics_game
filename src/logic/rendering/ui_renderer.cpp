...
ui_renderer::ui_renderer(const std::shared_ptr<simple_color_object>& no_moves_left,
                         const std::shared_ptr<simple_color_object>& moves_left)
    : no_moves_left_{new buffered_simple_color_object{no_moves_left}},
      moves_left_{new buffered_simple_color_object{moves_left}},
      state_{ui_moves_state::moves_left}
{
}

void ui_renderer::render(shader_program& program, const glm::vec4 color) const
{
    ...
    {
    case moves_left:
        indicator_to_render = moves_left_.get();
        break;
    case no_moves_left:
        indicator_to_render = no_moves_left_.get();
        break;
    }
